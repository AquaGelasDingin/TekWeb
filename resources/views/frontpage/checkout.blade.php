        ...
        <div class="container p-12 mx-auto">
            <div class="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div class="flex flex-col md:w-full">
                    <h2 class="mb-4 font-bold md:text-xl text-heading ">Are You Sure Stranger?
                    </h2>
                    <form class="justify-center w-full mx-auto" method="head" action>
                        <div class="">
                ...
                <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                    <div class="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div class="mt-8">
                            <div class="flex flex-col space-y-4">
                                <div class="flex space-x-4">
                                    ...
                                    <div>
                                        <h2 class="text-xl font-bold">3 Games Multiplayer</h2>
                                        <p class="text-sm">Phasmophobia, Devour, Left 4 Dead</p>
                                        <span class="text-red-600">Price</span> 223K
                                    </div>
                                    <div>
                        ...
                        <div
                            ...
                            Subtotal<span class="ml-2">223K</span></div>
                        <div
                            class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Total<span class="ml-2">223K</span></div>
                    </div>
                </div>
            </div>
        </div>
